...
const FourDone = ({ onSave }) => {
  const navigate = useNavigate();
  return (
    <>
      <div className="fixed inset-0 bg-black opacity-50 z-40"></div>
      <section className="fixed inset-0 flex flex-col justify-center items-center px-5 py-4 z-50">
        <main className="flex relative flex-col md:flex-row justify-between bg-white rounded-3xl w-[800px] max-w-[850px] max-h-[580px] max-md:px-5 max-md:py-24">
