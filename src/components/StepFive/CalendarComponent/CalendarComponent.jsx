...
// import Calendar from 'react-calendar';, { useState } 
...
const CalendarComponent = () => {
    ...
    return (
        <div className="flex flex-col justify-center p-8 bg-white max-w-[796px] rounded-[31px] shadow-[8px_8px_24px_rgba(32,32,32,0.1)] text-neutral-800">
