...
const Pricing = () => {
  return (
    <section className="flex flex-col px-24 py-1 w-full max-md:px-5 max-md:max-w-full">
      <div className="flex flex-col justify-center px-10 py-3 mt-2 w-full min-h-[325px] rounded-[32px] bg-gradient-to-r from-indigo-300 to-indigo-500 max-md:px-5 max-md:mt-10 max-md:max-w-full"> {/* Added gradient background */}
